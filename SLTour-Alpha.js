...
function introTour(language) {
  var translations = {
    ...
    full: {
      ...
      arabic: 'جرب متعة الانغماس الكامل وارتق بمواجهاتك الرقمية إلى آفاق جديدة مع وضع ملء الشاشة.',
      urdu: 'مکمل وسرجن کی خوشی کا تجربہ کریں اور فل سکرین موڈ کے ساتھ اپنے ڈیجیٹل مقابلوں کو نئی بلندیوں تک لے جائیں۔.',
      dutch: 'Erleben Sie die Freude am vollständigen Eintauchen und heben Sie Ihre digitalen Begegnungen mit dem Vollbildmodus auf ein neues Niveau.',
