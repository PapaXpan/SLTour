  ...
  var translations = {
    ...
    titles: {
      ...
      dutch: {
        ...
        menu: 'Cursusmenu',
        play: 'Afspelen van diavoorstelling bedienen',
        replay: 'Replay',
      ...
      spanish: {
        ...
        menu: 'Menú del curso',
        captions: 'Subtítulos',
        play: 'Control de reproducción de diapositivas',
        replay: 'Replay',
      ...
      french: {
        ...
        menu: 'Menu du cours',
        play: 'Contrôle de lecture des diapositives',
        replay: 'Replay',
      ...
      portuguese: {
        ...
        menu: 'Menu do curso',
        play: 'Controle de reprodução de slides',
        replay: 'Replay',
        captions: 'Legendas',
      ...
      },
    {
      ...
      },
      {
        ...
        title: translations['titles'][language]['play'],
            ...
            {
        element: '#reset',
        intro: translations['replay'][language],
        title: translations['titles'][language]['replay'],
      },
      {
        element: '#captions',
